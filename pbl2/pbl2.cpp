...
{
    (*cayisbn).xoanode(book->getIsbn(), book);
    (*caytheloai).xoanode(book->getSubject(), book);
    (*caytacgia).xoanode(book->getAuthor(), book);
    (*caytieude).xoanode(book->getTitle(), book);
    (*caynxb).xoanode(book->getPublisher(), book);
    (*caynam).xoanode(to_string(book->getDate().getnam()), book);
